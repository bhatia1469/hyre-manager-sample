...
- (void)pushRegistry:(PKPushRegistry *)registry didUpdatePushCredentials:(PKPushCredentials *)credentials forType:(NSString *)type {
  ...
  NSLog(@"RNVoipPushNotificationManager didUpdatePushCredentials:credentials forType:(NSString *)type");
...
didReceiveIncomingPushWithPayload:(PKPushPayload *)payload
  ...
  if ([UIApplication sharedApplication].applicationState != UIApplicationStateActive && ![RNCallKeep isCallActive:uuid]) {
    ...
    [RNCallKeep reportNewIncomingCall:uuid handle:callerName handleType:@"generic" hasVideo:NO localizedCallerName:callerName fromPushKit:YES payload:payload.dictionaryPayload];
  }
}
